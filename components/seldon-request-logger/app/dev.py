...
#         error_msg = ex
#     sys.stdout.flush()
#     return Response(f"problem logging request: {error_msg}", 500)
#
#
...
#                                        bulk_doc_body[message_type].copy(), request_id, index_name)
#         else:
...
#         elements = createElelmentsArray(content_np, None, namespace, serving_engine, inferenceservice_name, endpoint_name, message_type)
#         copy["elements"] = elements
#         print("PREDICTIONS ELEMENTS: ", copy["elements"])
#
...
#     else:
#         print('missing a param required for metadata lookup:', [namespace_name, inferenceservice_name, serving_engine, endpoint_name])
#         sys.stdout.flush()
#
#     results = None
#     if not metadata_schema:
#         print(f"NOT creating elements with metadata for {inferenceservice_name}")
#         results = createElementsNoMetadata(X, names, results)
#     else:
#         print(f"creating elements with metadata for {inferenceservice_name}")
